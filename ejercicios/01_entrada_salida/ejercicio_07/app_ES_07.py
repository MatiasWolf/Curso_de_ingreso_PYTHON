...
class App(customtkinter.CTk):
    ...
    def btn_restar_on_click(self):
        ...
        operador_b_numero = int(operador_b)
        resultado_suma = operador_a_numero - operador_b_numero
        mensaje = f"El resultado de la resta es: {resultado_suma}"
        alert("Calculadora", mensaje)
    ...
    def btn_multiplicar_on_click(self):
        ...
        operador_b_numero = int(operador_b)
        resultado_suma = operador_a_numero * operador_b_numero
        mensaje = f"El resultado de la multiplicación es: {resultado_suma}"
        alert("Calculadora", mensaje)
    ...
    def btn_dividir_on_click(self):
        ...
        operador_b_numero = int(operador_b)
        resultado_suma = operador_a_numero / operador_b_numero
        mensaje = f"El resultado de la división es: {resultado_suma:.0f}"
        alert("Calculadora", mensaje)
